...
class BoardTest {
    ...
    void testBorders1(){
        ...
        boolean result = board.withinBorders(0, 0);
    ...
    void testBorders2(){
        ...
        boolean result = board.withinBorders(0, 2);
    ...
    void testBorders3(){
        ...
        boolean result = board.withinBorders(0, -1);
        assertEquals(false, result);
    }
    ...
    void testBorders4(){
        ...
        boolean result = board.withinBorders(2, 0);
        assertEquals(false, result);
    }
    ...
    void testBorders5(){
        ...
        boolean result = board.withinBorders(-1, 0);
        assertEquals(false, result);
    }
}
