...
public class SpriteTest {
    ...
    @Test
    void testDraw1() throws IOException {
        SpriteStore spriteStore = new SpriteStore();
        sprite = (ImageSprite) spriteStore.loadSprite("/sprite/apple.png");
        assertThrows(NullPointerException.class, () -> sprite.draw(null, 0, 0, 0, 0));
    }
}
